...
class AmqpService {
    ...
    start() {
        amqp.connect(process.env.CLOUDAMQP_URL + "?heartbeat=" + process.env.CLOUDAMQP_HEARTBEAT, function (err, conn) {
            if (err) {
...
function whenConnected() {
    ...
    setInterval(function () {
        var historico = { id: "drone1", temperatura: 10, umidade: 40, latitude: 10, longitude: 10 };
